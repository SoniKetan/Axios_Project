...
function storingDataOnCrudByAxios(event){
    ...
    axios.post("https://crudcrud.com/api/0eb0fe86af9548b0b51677064ce8062a/hajirHukum", latestObj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded", () =>{
    axios.get("https://crudcrud.com/api/0eb0fe86af9548b0b51677064ce8062a/hajirHukum")
    .then((response) => {
        console.log(response);
...
function showingDataOnDisplay(latestObj){
    ...
    deleteBtn.onclick = () => {
        ...
        axios.delete(`https://crudcrud.com/api/0eb0fe86af9548b0b51677064ce8062a/hajirHukum/${latestObj._id}`)
        .then((res) => {
            console.log(res);
