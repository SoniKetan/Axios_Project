...
function storingDataOnCrudByAxios(event){
    ...
    axios.post("https://crudcrud.com/api/7187dfbc3a544db7b0e46d152925ab46/chikuChikki", latestObj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded", () =>{
    axios.get("https://crudcrud.com/api/7187dfbc3a544db7b0e46d152925ab46/chikuChikki")
    .then((response) => {
        console.log(response);
...
function showingDataOnDisplay(latestObj){
    ...
    deleteBtn.onclick = () => {
        ...
        axios.delete(`https://crudcrud.com/api/7187dfbc3a544db7b0e46d152925ab46/chikuChikki/${latestObj._id}`)
        .then((res) => {
            console.log(res);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    editBtn.onclick = () => {
        ...
        axios.put(`https://crudcrud.com/api/7187dfbc3a544db7b0e46d152925ab46/chikuChikki/${latestObj._id}`)
        .then((res) => {
            console.log(res);
            for(let i = 0; i < res.data.length; i++)
            {
